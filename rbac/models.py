...
class Permission(models.Model):
    ...
    menu = models.ForeignKey(verbose_name='所属菜单', to='Menu', on_delete=models.DO_NOTHING,
                             null=True, blank=True, help_text='null表示不是菜单;非null表示是二级菜单')

    pid = models.ForeignKey(verbose_name='关联的权限', to='Permission', on_delete=models.DO_NOTHING,
