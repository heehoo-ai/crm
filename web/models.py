...
class UserInfo(RbacUserInfo):
    ...
    depart = models.ForeignKey(verbose_name='部门', to="Department", on_delete=models.DO_NOTHING,)
...
class ClassList(models.Model):
    ...
    """
    school = models.ForeignKey(verbose_name='校区', on_delete=models.DO_NOTHING, to='School')
    course = models.ForeignKey(verbose_name='课程名称', on_delete=models.DO_NOTHING, to='Course')
    ...
    class_teacher = models.ForeignKey(verbose_name='班主任', to='UserInfo', related_name='classes',on_delete=models.DO_NOTHING,
...
class ConsultRecord(models.Model):
    ...
    客户跟进记录
    """
    customer = models.ForeignKey(verbose_name="所咨询客户", to='Customer',on_delete=models.DO_NOTHING,)
    consultant = models.ForeignKey(verbose_name="跟踪人", to='UserInfo',on_delete=models.DO_NOTHING,)
...
class PaymentRecord(models.Model):
    ...
    consultant = models.ForeignKey(verbose_name="课程顾问", to='UserInfo', help_text="谁签的单就选谁",on_delete=models.DO_NOTHING,)
    pay_type_choices = [
        (1, "报名费"),
        (2, "学费"),
        (3, "退学"),
    ...
    confirm_user = models.ForeignKey(verbose_name="审批人", to='UserInfo', on_delete=models.DO_NOTHING,
...
class Student(models.Model):
    ...
    学生表
    """
    customer = models.OneToOneField(verbose_name='客户信息', on_delete=models.DO_NOTHING, to='Customer')
...
class ScoreRecord(models.Model):
    ...
    积分记录
    """
    student = models.ForeignKey(verbose_name='学生', to='Student', on_delete=models.DO_NOTHING,)
    content = models.TextField(verbose_name='理由')
    score = models.IntegerField(verbose_name='分值', help_text='违纪扣分写负值，表现邮寄加分写正值')
    user = models.ForeignKey(verbose_name='执行人', on_delete=models.DO_NOTHING, to='UserInfo')
...
class CourseRecord(models.Model):
    ...
    上课记录表
    """
    class_object = models.ForeignKey(verbose_name="班级", on_delete=models.DO_NOTHING, to="ClassList")
    day_num = models.IntegerField(verbose_name="节次")
    teacher = models.ForeignKey(verbose_name="讲师", on_delete=models.DO_NOTHING, to='UserInfo')
...
class StudyRecord(models.Model):
    ...
    学生考勤记录
    """
    course_record = models.ForeignKey(verbose_name="第几天课程", on_delete=models.DO_NOTHING, to="CourseRecord")
    student = models.ForeignKey(verbose_name="学员", on_delete=models.DO_NOTHING, to='Student')
    record_choices = (
        ('checked', "已签到"),
        ('vacate', "请假"),
        ('late', "迟到"),
